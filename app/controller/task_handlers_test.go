...
func TestHandler_CreateSolution(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			r := fiber.New()
			r.Post("/solution", handler.CreateTask)
...
func TestHandler_UpdateSolution(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			r := fiber.New()
			r.Put("/solution", handler.UpdateTask)
...
func TestHandler_GetSolution(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			r := fiber.New()
			r.Get("/solution", handler.GetTask)
...
func TestHandler_DeleteSolution(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			r := fiber.New()
			r.Delete("/solution", handler.DeleteTask)

			// Create Request
			req := httptest.NewRequest("DELETE", "/solution?"+test.paramsName+"=1",
				bytes.NewBufferString(""))
			req.Header.Set("Content-Type", "application/json")
...
func TestHandler_ConnectToSolution(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			r := fiber.New()
			r.Get("/connect", handler.ConnectToTask)
...
func TestHandler_SetExpertsWeights(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			inputBody: `[0.5, {"start":0.2, "end":0.4}, 0.6]`,
			inputRequest: InReq{
		...
		},
		{
			...
			expectedStatusCode:   400,
			expectedResponseBody: `{"message":"json: cannot unmarshal object into Go value of type entity.Weights"}`,
		},
		{
			name:       "Wrong URL",
			paramsName: "sssssid",
